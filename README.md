...
- [ ] Expand to 100+ prompts with gender-neutral names
- [ ] Add 20+ non-causal prompts for proper causal vs non-causal comparison  
- [ ] Apply direct logit attribution to L7H3
- [ ] Test on other causal connectives ("so", "therefore", "thus")
- [ ] Compare circuit across GPT-2 Medium and Large
...
and [circuitsvis](https://github.com/alan-cooney/CircuitsVis).*  
*Runs on Google Colab free tier — no local GPU needed.*
